...
import { Chapter, User, Subject, SystemSettings, HtmlModule } from '../types';
import { FileText, Lock, ArrowLeft, Crown, Star, CheckCircle, AlertCircle, Globe } from 'lucide-react';
